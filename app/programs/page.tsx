...
export const metadata: Metadata = {
  ...
  description:
    'Explore Elevate Recovery’s full continuum of addiction treatment: medical detox, residential, PHP, IOP, outpatient, aftercare, and medication-assisted treatment in Toledo, Ohio.',
